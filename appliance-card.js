    ...
    root.innerHTML = `
      <style>
        ...
        .wrap {
          ...
          --power-bg: rgba(2, 132, 199, 0.1);
          --power-border: rgba(2, 132, 199, 0.25);
          --power-color: #0369a1;
          --accent-blue: #0284c7;
        ...
        .wrap.dark {
          ...
          --icon-shadow: 0 2px 8px rgba(0, 0, 0, 0.2);
          ...
          --shadow-effect: drop-shadow(0 6px 10px rgba(0, 0, 0, 0.3));
        }
